...
func main() {
	...
	userPremiereService := services.NewUserPremiereService(db)
	...
	userPremiereHandler := handlers.NewUserPremiereHandler(userPremiereService)
	...
	routes.SetupUserPremiereRoutes(e, userPremiereHandler, db)
